...
$this->nonPrintMargin = 1;        // Non-printable border at edge of paper sheet in mm
//	mPDF 5.5
// Avoid just the border/background-color of the end of a block being moved on to next page
$this->margBuffer = 0;            // Allows an (empty) end of block to extend beyond the bottom margin by this amount (mm)
